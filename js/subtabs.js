...
const SUBTAB_CONFIG = {
  analyze: [
    ...
    { label: '3 · Stress',     id: 'az-step3',  locked: true },
    { label: '4 · Ag Score',   id: 'az-step4',  locked: true },
    { label: '5 · Bioenergy',  id: 'az-step5',  locked: true },
    { label: '6 · Report',     id: 'az-step6',  locked: true },
  ],
  mapcompare: [
    { label: 'Map',           id: 'mc-map' },
